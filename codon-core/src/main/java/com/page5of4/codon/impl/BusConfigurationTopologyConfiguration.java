...
public class BusConfigurationTopologyConfiguration implements TopologyConfiguration {
   private static final String MESSAGE_TYPE = "messageType";
   private final BusConfiguration configuration;

   public BusConfigurationTopologyConfiguration(BusConfiguration configuration) {
